...
<body class="pt-24 pb-12 antialiased">
    ...
    <div class="max-w-4xl mx-auto px-6">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h2 class="text-3xl font-black text-white tracking-tight">Ostatnie Aktywności</h2>
        ...
        <?php if (empty($all_events)): ?>
            <div class="py-40 text-center bg-slate-900/40 rounded-3xl border border-white/5 border-dashed">
                ...
                <h3 class="text-xl font-bold text-slate-400">Brak zarejestrowanych zdarzeń</h3>
